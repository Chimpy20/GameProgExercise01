...
const FlyingInsect::Vertex FlyingInsect::InsectBoxVertices[ FlyingInsect::NumVertices ] =
{
	// Front face
...
void FlyingInsect::Initialise()
{
	...
	Vertex* const vertices = new Vertex[ NumVertices ];
	ASSERT( vertices != nullptr, "Couldn't create vertices.\n" );
	memcpy( vertices, InsectBoxVertices, sizeof( Vertex ) * NumVertices );
